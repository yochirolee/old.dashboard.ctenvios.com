   ...
   return (
      <Card className="flex flex-col">
         ...
         <CardContent className="flex-1 pb-0">
            <ChartContainer config={chartConfig} className="mx-auto aspect-square max-h-[200px]">
               <PieChart>
                  ...
                  <Pie data={chartData} dataKey="visitors" nameKey="status" innerRadius={60} strokeWidth={5}>
                     <Label
                        content={({ viewBox }) => {
         ...
         <CardFooter className="flex-col gap-2 text-sm">
            ...
            <div className="leading-none text-xs text-muted-foreground">Showing total packages in container</div>
         </CardFooter>
      </Card>
   );
}
